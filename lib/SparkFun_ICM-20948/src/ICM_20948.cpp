...
const __FlashStringHelper *ICM_20948::statusString(ICM_20948_Status_e stat)
{
  ...
  case ICM_20948_Stat_WrongID:
    ...
    break;
  case ICM_20948_Stat_InvalSensor:
    return F("Invalid Sensor");
    break;
  case ICM_20948_Stat_NoData:
    return F("Data Underflow");
    break;
  case ICM_20948_Stat_SensorNotSupported:
    return F("Sensor Not Supported");
    break;
  case ICM_20948_Stat_DMPNotSupported:
    return F("DMP Firmware Not Supported. Is #define ICM_20948_USE_DMP commented in util/ICM_20948_C.h?");
    break;
  case ICM_20948_Stat_DMPVerifyFail:
    return F("DMP Firmware Verification Failed");
    break;
  case ICM_20948_Stat_FIFONoDataAvail:
    return F("No FIFO Data Available");
    break;
  case ICM_20948_Stat_FIFOIncompleteData:
    return F("DMP data in FIFO was incomplete");
    break;
  case ICM_20948_Stat_FIFOMoreDataAvail:
    return F("More FIFO Data Available");
    break;
  case ICM_20948_Stat_UnrecognisedDMPHeader:
    return F("Unrecognised DMP Header");
    break;
  case ICM_20948_Stat_UnrecognisedDMPHeader2:
    return F("Unrecognised DMP Header2");
    break;
  case ICM_20948_Stat_InvalDMPRegister:
    return F("Invalid DMP Register");
    break;
  default:
